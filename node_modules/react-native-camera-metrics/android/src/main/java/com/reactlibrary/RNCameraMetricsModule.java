...
public class RNCameraMetricsModule extends ReactContextBaseJavaModule {

  private final ReactApplicationContext reactContext;

  public RNCameraMetricsModule(ReactApplicationContext reactContext) {
    super(reactContext);
